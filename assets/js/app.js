...
$('#sweetalert-08').click(function(e) {
    swal({
        title: 'Voulez-vous réellement annuler cet enregistrement?',
        text: "Cet opération est irreversible!",
        type: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Oui, Annulé-le!',
        confirmButtonClass: 'btn btn-success',
        cancelButtonClass: 'btn btn-danger',
    }).then((result) => {
        if (result.value) {
...
$('#sweetalert-09').click(function(e) {
    swal({
        title: 'Voulez-vous clôturer les écritures?',
        text: "Cette action est irreversible, une fois réalisé, aucune modification ne pourra être réalisé",
        type: 'Attention',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.value) {
            swal(
                'Cloturé!'
				,
                'L\'opération de clôture a été réalisé',
                'avec succès'
            )
        } else if (
            ...
            swal(
                'Annulée',
                'L\'opération de clôture a été annulé ',
                'Erreur'
            )
        }
    })
