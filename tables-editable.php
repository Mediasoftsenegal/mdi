...
<head>
    ...
    <meta content="Gestion de la caisse" name="description" />
                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1>Caisse</h1><?  echo 'Date : '. $_SESSION['dateDeb']; ?>
                                    </div>
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Encaissement - Décaissement</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="form-row">		
												<div class="col-sm-4">
													<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myenc">(+) Encaisses</button>
												</div>
												<div class="col-sm-4"></div>
												<div class="col-sm-4">
													<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#mydec">(-) Décaisses</button>
												</div> 
												</div>
                                            </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="table table-striped mb-0">
                                            <table id="datatable" class="display compact table table-striped table-bordered">
                                                ...
                                                <tbody>
													...
													if(isset($_POST['search'])){
														$sql = "SELECT * FROM public.md_caisse WHERE etat=TRUE AND date_op BETWEEN '$dateDeb' AND '$dateFin' ORDER BY  num_op ASC";
													} else
													{
														$sql = "SELECT * FROM public.md_caisse WHERE etat=TRUE AND date_op BETWEEN '". $_SESSION['dateDeb'] ."' AND '". $_SESSION['dateFin']."' ORDER BY  num_op ASC";			
													}			
							...
							<div class="col-12 col-lg-12">
                                <div class="alert alert-primary">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <p class="text-white"> Clôture de la Caisse ===>  Action à éffectuer uniquement à la fin de chaque journée ! </p>
                                        </div>
                                    </div>
								...
								<form method="POST" action="insert_ran.php" class="form-signin" >
									<div class="row">
										...
										<div class="col-sm">
                                            <button  id="sweetalert-09"  name="clos" value='clos' class="btn btn-success" aria-label="Try me! Example: en passant un paramètre, vous pouvez exécuter autre chose pour 'Annuler'">Clôturer la caisse du jour : <?  //echo $date; ?></button> 
										</div>
					...
					<!-- end page title -->     
                        ...
                        <div class="modal fade" id="mydec" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="verticalCenterTitle">   Fiche Décaissement </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
