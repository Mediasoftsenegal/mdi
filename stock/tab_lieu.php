                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="navigation d-flex">
                            <ul class="navbar-nav nav-left">
								...
								<li class="nav-item">
                                    <a class="nav-link   id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Caisse  &nbsp; &nbsp;   <button type="button" class="btn btn-info" >Caisse </button><button type="button" class="btn btn-info" >Gestion de stock </button></a> <a class="nav-link   id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> &nbsp;</a> 
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            <li class="nav-static-title"><? echo 'Profil:'.$_SESSION["Profileur"].'-'.$_SESSION["id_user"];?></li>
                             ...
                             <li><a href="tab_stock.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Sortie de stock</span></a> </li>
							 <li><a href="tab_stock.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Evolution du stock</span></a> </li>
                          </span></a>    
                            </li>
                            <li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Lieux de stockage</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="form-row">		
												<div class="col-sm-4">
													<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myenc">(+) Lieux de stockage</button>
												</div>
                                                ...
                                                <tbody>
                                                    ...
                                                    $resultset->execute();
                                                        ...
                                                        while ($row = $resultset->fetch(PDO::FETCH_ASSOC))
														{
                                                             ?>   
                                                        <tr>	
															 <td><?echo $row['id_produit'];?></td>
                                                            <td><?echo $row['designation'];?></td> 
															<td><?echo $row['nom_lieu'];?></td> 
															<td><?echo $row['litre_cm'];?></td> 
															<td><?echo $row['kg_cm'];?></td> 
															
															<td><?echo '<a href="form_lieu.php?id='.$row['id_lieu'].'" data-toggle="tooltip" data-placement="right" title="" data-original-title="Modifier un produit" class="btn btn-icon btn-xs btn-outline-success"><i class="fa fa-edit"></i></a>&nbsp;
															<a href="form_lieu.php?id='.$row['id_lieu'].'" data-toggle="tooltip" data-placement="right" title="" data-original-title="supprimer un produit" class="btn btn-icon btn-xs btn-outline-danger"><i class="fa fa-trash"></i></a>';?></td> 								
														</tr>        
													<?} ?>
                                                    <?php
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
										...
										<? $sql = "SELECT id_produit,designation FROM public.md_produit ORDER BY id_produit ASC";			
											...
											<div class="col-12">
												...
												<input style="text" class="form-control" value="0" name="lcm" placeholder="Litres par cm " />
								
												</div>
												<div class="form-group">
												<label class="control-label">Kg par cm </label>												
												<input style="text;" class="form-control"  value="0" name="kgcm" placeholder="Kg par cm " />
												</div>
											</div>
										</div>
									</div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" name="btn_lieu">Valider</button>
                                    </div>
								</div>
                                </div>
                            </div>
