...
<head>
    ...
    <meta content="Gestion du stock" name="description" />
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Sortie de stock</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div class="card card-statistics">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title">Gestion Des Sorties De Stock</h4>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <div class="datatable-wrapper table-responsive">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <table id="example" class="display compact table table-striped table-bordered dataTable" role="grid" aria-describedby="datatable_info">
                                                                <thead>
                                                                    <tr role="row">
                                                                        <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="choisir: activate to sort column descending" style="width: 263.625px;"></th>
                                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Date sortie: activate to sort column ascending" style="width: 414.281px;">Date sortie</th>
                                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Désignation: activate to sort column ascending" style="width: 197.703px;">Désignation</th>
                                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Libellé: activate to sort column ascending" style="width: 103.422px;">libellé</th>
                                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Quantité: activate to sort column ascending" style="width: 184.562px;">Quantité</th>
                                                                    </tr>
                                                                </thead>                                    
                                                                <tbody>   
                                                <?		
												$sql = "SELECT md_produit.id_produit,md_produit.designation,md_entree_sortie.date_entreesortie, 
                                                md_entree_sortie.libelle_entreesortie,md_entree_sortie.qte_entree_sortie,
                                                ...
                                                AND md_entree_sortie.type_entresortie='Sortie'																							
                                                ...
                                                <tr role="row" class="odd">
                                                        <td class="sorting_1"><a href="tab_sortie.php?id=<?echo $row['id_entreesortie'];?>">Choisir</a></td>
                                                        ...
                                                        <td><?echo $row['qte_entree_sortie'];?></td>
                                                        <?} ?>
                                                <?php
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">Date sortie</th>
                        ...
                        <div class="card card-statistics">
                            <div class="card-header">
                                <div class="card-heading"><h4 class="card-title">Saisie Sortie</h4></div>
                            </div>
                            <div class="card-body">
                                <? if(isset($_GET['id'])){ 
                                        $sql="SELECT md_produit.id_produit,md_produit.designation,md_entree_sortie.date_entreesortie, 
                                        ...
                                        $res->execute();
                                        $rowd = $res->fetch(PDO::FETCH_ASSOC);}
                                        ?>	
                            <div class="card-body">
                                ...
                                <? $sql = "SELECT id_produit,designation FROM public.md_produit ORDER BY id_produit ASC";			
									...
									<div class="col-12">
                                        ...
                                        <? if(isset($_GET['id'])){ ?>	
                                        <input type="hidden" class="form-control" name="id_sortie" value="<? echo $rowd['id_entreesortie'] ;?> "/>   										
										<input type="date" class="form-control"  name="date_sortie" value="<? echo $rowd['date_entreesortie']; ?>"/>
                                        <?} else {?>
                                        <input type="date" class="form-control"  name="date_sortie" placeholder="Date " />           
                                         <?}?>
                                        </div>
									<div class="form-group">
										...
										<? if (isset($_GET['id'])) {?> 
                                             <option value="<? echo $rowd['id_produit']; ?>"><?echo $rowd['designation']; ?></option>
                                        <? } else {?>
                                             <option>Choisir un produit</option>        
												...
												<div class="form-group">
												<label class="control-label">Libellé sortie </label>	
                                                <? if (isset($_GET['id'])) {?>           
												<input style="text" class="form-control"  name="libelle_sortie" value="<? echo $rowd['libelle_entreesortie'] ;?> "/>
                                                <? } else {?>
                                                <input style="text" class="form-control"  name="libelle_sortie" placeholder="Libellé sortie" />
												</div>
												<? }?>	
												<div class="form-group">
												<label class="control-label">Quantité sortie </label>	
                                               <? if (isset($_GET['id'])) {?>
                                                <input style="number" step="0.01" class="form-control"   name="qte_sortie" value="<? echo $rowd['qte_entree_sortie'] ;?> " />
												
                                                <? } else {?>
                                                <input style="number" step="0.01" class="form-control"   name="qte_sortie" placeholder="Quantité sortie " />
												</div>
                                                <? }?>										
                                            ...
                                            <div class="form-group">
                                            <button type="submit" class="btn btn-warning" name="toudou_sor" data-dismiss="">Modifier</button>
                                            <button type="submit" class="btn btn-success" name="doli_sor">Valider</button>
                                            <button type="submit" class="btn btn-danger" name="dindi_sor">Supprimer</button>
                                            </div>
                                        </form>
                                    </div>
                                    </div>
