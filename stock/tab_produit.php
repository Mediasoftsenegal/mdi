                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            <li class="nav-static-title"><? echo 'Profil:'.$_SESSION["Profileur"].'-'.$_SESSION["id_user"];?></li>                           
							 ...
							 <li><a href="evol_stock.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Evolution du stock</span></a> </li>
                            </li>
                            <li>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="form-row">		
												<div class="col-sm-4">
													<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myenc">(+) Produit</button>
												</div>
                                    ...
                                    <div class="card-body">
                                        <div class="table table-striped mb-0">
                                            <table id="example" style="width:100%" class="display compact table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?				
													$sql = "SELECT * FROM public.md_produit ORDER BY id_produit ASC";			
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="verticalCenterTitle">   Nouveau produit </h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
											<div class="col-12">
												...
												<input style="text-transform: uppercase;" class="form-control"  name="designation" placeholder="Désignation" />
												</div>
											</div>
										</div>
									</div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" name="btn_produit">Valider</button>
                                    </div>
								</div>
                                </div>
                            </div>
