                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="ui-media.html">Media</a> </li>
                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h4>CAISSE PRINCIPALE : CP En Date du <?echo date('d/m/y');?></h4>
                                    </div>
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Caisse</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="card card-statistics media-contant">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Rechercher par période</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="media">
											<form method="POST" action="insert.php">
												<div class="input-group" data-date="23/11/2018" data-date-format="dd-mm-YYYY">
													<input type="text" class="form-control range-from" name="from">
														...
														<div class="col-sm-2"> <button type="button" name="search" class="btn btn-icon btn-success"><i class="fa fa-search"></i></button>
														</div>
												</div>
											</form>
                                        </div>
