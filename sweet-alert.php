                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="ui-sweet-alert.html">Sweet Alert</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Sweet Alert</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row sweet-wrapper">
                            <div class="col-md-6 mb-30">
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A basic message</h5>
                                        <button id="sweetalert-01" class="btn btn-primary" aria-label="Try me! Example: A basic message">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A title with a text under</h5>
                                        <button id="sweetalert-02" class="btn btn-primary" aria-label="Try me! Example: A title with a text under">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A modal with a title, an error icon, a text, and a footer</h5>
                                        <button id="sweetalert-03" class="btn btn-primary" aria-label="Try me! Example: A modal with a title, an error icon, a text, and a footer">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A modal window with a long content inside:</h5>
                                        <button id="sweetalert-04" class="btn btn-primary" aria-label="Try me! Example: A modal window with a long content inside">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">Custom HTML description and buttons </h5>
                                        <button id="sweetalert-05" class="btn btn-primary" aria-label="Try me! Example: Custom HTML description and buttons">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title"> A custom positioned dialog </h5>
                                        <button id="sweetalert-06" class="btn btn-primary" aria-label="Try me! Example: A custom positioned dialog">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">jQuery HTML with custom animation </h5>
                                        <button id="sweetalert-07" class="btn btn-primary" aria-label="Try me! Example: jQuery HTML with custom animation">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <h5 class="card-title">A warning message, with a function attached to the 'Confirm'-button </h5>
                                        <button id="sweetalert-08" class="btn btn-primary" aria-label="Try me! Example: A warning message, with a function attached to the 'Confirm'-button">Try me!</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-30">
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">En passant un paramètre, vous pouvez exécuter autre chose pour 'Annuler </h5>
                                        <button id="sweetalert-09" class="btn btn-primary" aria-label="Try me! Example: en passant un paramètre, vous pouvez exécuter autre chose pour 'Annuler'">Test!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A message with a custom image and CSS animation disabled </h5>
                                        <button id="sweetalert-10" class="btn btn-primary" aria-label="Try me! Example: A message with a custom image and CSS animation disabled">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A message with custom width, padding and background </h5>
                                        <button id="sweetalert-11" class="btn btn-primary" aria-label="Try me! Example: A message with custom width, padding and background">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">A message with auto close timer </h5>
                                        <button id="sweetalert-12" class="btn btn-primary" aria-label="Try me! Example: A message with auto close timer">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">Right-to-left support for Arabic, Hebrew, and other RTL languages </h5>
                                        <button id="sweetalert-13" class="btn btn-primary" aria-label="Try me! Example: A message with auto close timer">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">Ajax request </h5>
                                        <button id="sweetalert-14" class="btn btn-primary" aria-label="Try me! Example: Ajax request">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">Chaining modals (queue) </h5>
                                        <button id="sweetalert-15" class="btn btn-primary" aria-label="Try me! Example: Chaining modals (queue)">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <h5 class="card-title"> Dynamic queue </h5>
                                        <button id="sweetalert-16" class="btn btn-primary" aria-label="Try me! Example: Dynamic queue">Try me!</button>
                                    </div>
                                </div>
                            </div>
                        </div>
