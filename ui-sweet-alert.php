                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row sweet-wrapper">
                            ...
                            <div class="col-md-6 mb-30">
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
                                        <h5 class="card-title">Passing a parameter, you can execute something else for 'Cancel </h5>
                                        <button id="sweetalert-09" class="btn btn-primary" aria-label="Try me! Example: passing a parameter, you can execute something else for 'Cancel'">Try me!</button>
                                    </div>
                                </div>
                                <div class="card card-statistics mb-30">
                                    <div class="card-body">
