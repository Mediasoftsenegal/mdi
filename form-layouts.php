                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="form-layouts.html">Forms Layouts</a> </li>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <fieldset class="form-group">
                                                <div class="row">
                                                    <div class="col-form-label col-sm-3 pt-3">Radios</div>
                                                    <div class="col-sm-9">
                                                        <div class="form-check">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3 pt-3">Checkbox</div>
                                                <div class="col-sm-9">
                                                    <div class="form-check">
                                    ...
                                    <div class="card-body">
                                        <form class="form-inline">
                                            ...
                                            <div class="form-check mb-2 mr-sm-2">
                                                ...
                                                <label class="form-check-label p-l-30" for="inlineFormCheck">
                                                    Remember me
                                                </label>
                                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Help Text</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form>
