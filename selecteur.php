                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    ...
                                    <li class="active"> <a href="form-input-groups.html">Input Groups</a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Input Groups</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        <div class="card-heading">
                                            <h4 class="card-title">Button With Dropdowns</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text">Button</label>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="inputGroupFileAddon03">Button</span>
                                            </div>
                                            <div class="custom-file">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="inputGroupFileAddon04">Button</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
